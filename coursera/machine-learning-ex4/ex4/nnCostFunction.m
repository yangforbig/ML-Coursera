...
for i = 1:m;
    ...
    delta2 = delta2(2:end);
    delta2 = delta2.*sigmoidGradient(X(i,:) * Theta1');
    ...
    Theta1_grad = Theta1_grad / m + lambda / m * Theta1_R; 
    Theta2_grad = Theta2_grad / m + lambda / m * Theta2_R;
